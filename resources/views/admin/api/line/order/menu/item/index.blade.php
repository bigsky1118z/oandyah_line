...
<dl class="dl-flex-left">
    <dd><a href="/api/line/{{ $channel->channel_name }}/order/menu">メニュー一覧</a></dd>
    <dd><a href="/api/line/{{ $channel->channel_name }}/order/menu/{{ $group }}/edit">メニュー編集</a></dd>
    <dd><a href="/api/line/{{ $channel->channel_name }}/order/menu/{{ $group }}/delete">メニュー削除</a></dd>
</dl>
<dl class="dl-flex-left">
    <dd><a href="/api/line/{{ $channel->channel_name }}/order/menu/{{ $group }}/item/create">商品追加</a></dd>
</dl>
<dl class="dl-flex-left">
    <dt>ID</dt>
    <dt>カテゴリ</dt>
